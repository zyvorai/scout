...
# Emoji-rich deploy UI (self-contained; no cross-repo imports). Project-agnostic —
# configured entirely through the DEPLOY_UI_* variables set in deploy-common.sh.
